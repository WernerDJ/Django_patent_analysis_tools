...
<div style="margin-top: 2em;">
  ...
  <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin-top: 1em; border: 1px solid #ccc; border-radius: 8px;">
    <img src="https://www.youtube.com/embed/eo31FWVMW_o?si=hmpVeIAeSrjxdBOC" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></img>
  </div>
</div>
